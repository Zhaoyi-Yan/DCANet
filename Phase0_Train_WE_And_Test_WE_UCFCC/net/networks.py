...
from net.HRNet.hrnet_aspp_relu_phase3 import HighResolutionNet as HRNet_aspp_relu_phase3
from net.HRNet.hrnet_aspp_relu_softmax_1 import HighResolutionNet as HRNet_aspp_relu_softmax1
from net.HRNet.hrnet_aspp_relu_fiveDomain_phase3 import HighResolutionNet as HRNet_aspp_relu_fiveDomain_phase3
...
def define_net(net_name):
    ...
    elif net_name == 'hrnet_aspp_relu_softmax_1': # This one is main!
        net = HRNet_aspp_relu_softmax1()
        net.init_weights('hrnetv2_w40_imagenet_pretrained.pth')
    elif net_name == 'hrnet_aspp_relu': # This one is main!
        net = HRNet_aspp_relu()
        net.init_weights('hrnetv2_w40_imagenet_pretrained.pth')
    elif net_name == 'hrnet_aspp_relu_phase3': # This one is main!
        net = HRNet_aspp_relu_phase3(attn_weight=1, fix_domain=1, domain_center_model='average_clip_domain_center_54.89.npz')
        net.init_weights('hrnetv2_w40_imagenet_pretrained.pth')
    elif net_name == 'hrnet_aspp_relu_phase3_fiveDomain': # This one is main!
        net = HRNet_aspp_relu_fiveDomain_phase3(attn_weight=1, fix_domain=1, domain_center_model='average_clip_domain_center_67.06_fast_ori.npz')
        net.init_weights('hrnetv2_w40_imagenet_pretrained.pth')
    elif net_name == 'res_unet_leaky':
        net = FPN(leaky_relu=True)
    elif net_name == 'res_unet_aspp':
        net = FPN(is_aspp=True)
    elif net_name == 'res_unet_aspp_leaky':
        net = FPN(leaky_relu=True, is_aspp=True)
    else:
