...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataset_name', type=str, default='WorldExpo', help='SHA|SHB|QNRF|UCF50|WorldExpo')
        parser.add_argument('--test_model_name', type=str, default='', help='the model to test')
        parser.add_argument('--scene_index', type=int, default=1, help='1|2|3|4|5')
        ...
        parser.add_argument('--name', type=str, default='Res_unet_aspp_', help='name of the experiment. It decides where to store samples and models')
