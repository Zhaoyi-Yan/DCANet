...
from net.HRNet.hrnet_fakeAspp_relu import HighResolutionNet as HRNet_fakeAspp_relu
...
def define_net(opt):
    ...
    if net_name == 'hrnet_relu':
        ...
        net = HRNet_aspp_relu()
        net.init_weights('hrnetv2_w40_imagenet_pretrained.pth')
    elif net_name == 'hrnet_relu_fakeAspp': # This one is main!
        net = HRNet_fakeAspp_relu()
        net.init_weights('hrnetv2_w40_imagenet_pretrained.pth')
    else:
