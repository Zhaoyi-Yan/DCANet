...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataset_name', default='JSTL_', help='SHA|SHB|QNRF')
        parser.add_argument('--batch_size', type=int, default=5, help='input batch size')
        parser.add_argument('--weight_scale', type=float, default=0.0, help='the scale of channel')
        ...
        parser.add_argument('--name', type=str, default='Res_unet_aspp_1e4_b5', help='name of the experiment. It decides where to store samples and models')
