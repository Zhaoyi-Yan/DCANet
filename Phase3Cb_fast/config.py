...
class config(object):
    def __init__(self, opt):
        ...
        elif self.dataset_name == 'JSTL_large_5_dataset':

            self.train_gt_map_path = '../JSTL_large_5_dataset/den/train'
            self.eval_gt_map_path = '../JSTL_large_5_dataset/den/test'
            self.train_img_path = '../JSTL_large_5_dataset/ori/train_data/images'
            self.eval_img_path = '../JSTL_large_5_dataset/ori/test_data/images'
            self.eval_gt_path = '../JSTL_large_5_dataset/ori/test_data/ground_truth'
            self.datasets_com = ['SHA', 'SHB', 'QNRF_large', 'UCF_CC_50', 'WorldExpo']
