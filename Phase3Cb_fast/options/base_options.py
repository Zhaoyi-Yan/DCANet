...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataset_name', default='JSTL_large', help='SHA|SHB|QNRF')
        ...
        parser.add_argument('--domain_center_model', type=str, default='average_clip_domain_center_54.97.npz', help='the path of the domain center domain calculated in Phase 2')
        ...
        parser.add_argument('--cosine', type=int, default=1, help='whether using consine distance to measure the similarity of predict attention with domain center')
        parser.add_argument('--loss_attn_weight', type=float, default=1., help='the weight of loss attn')
        parser.add_argument('--attn_weight_path', type=str, default='./feature_weights_scale_0.0', help='the path of attention weights got from phase 2')
        parser.add_argument('--is_mae', type=int, default=1, help='1 for delta_mae and 0 for delta_mse')
        parser.add_argument('--net_name', type=str, default='hrnet_aspp_relu', help='res_unet|res_unet_leaky')
