...
npys = glob.glob("feature_weights_total_MAE_67.06_scale_0.0_fast_out_ori/*npz")
...
np.savez('average_clip_domain_center_67.06_fast_ori.npz', G_SHA = G_SHA, G_SHB = G_SHB, G_QNRF = G_QNRF, G_NWPU = G_NWPU, G_JHU = G_JHU)
